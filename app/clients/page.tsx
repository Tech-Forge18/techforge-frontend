...
const clients = [
  {
    ...
    contactInfo: "John Doe, john@acme.com, +1 123-456-7890",
    status: "Active",
  },
  {
    id: 2,
    ...
    contactInfo: "Jane Smith, jane@techstart.com, +1 987-654-3210",
    status: "On Hold",
  },
...
export default function ClientsPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // Here you would typically send the new client to your backend
      ...
      {selectedClient && (
        <ClientDetail
          ...
          onUpdate={(updatedClient) => {
            // Here you would typically update the client in your backend
